            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php
                     ...
                     if($selected1 == '')
                     {
                       $selected1 = (isset($quote->id) ? $quote->id: '');
                     }
                     ?>
                  <?php $auto_toggle_class = (isset($contract) || isset($do_not_auto_toggle) ? '' : 'auto-toggle'); ?>
                  <?php echo render_select('rel_id',$quotes,array('id','quote_name'),'Mã báo giá',$selected1,array(),array(),'point-ev',$auto_toggle_class); ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group" data-toggle="tooltip" title="<?php echo _l('contract_value_tooltip'); ?>">
                        ...
                        <input type="number" class="form-control" name="contract_value" value="0" readonly>
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group" data-toggle="tooltip" title="<?php echo _l('contract_value_tooltip'); ?>">
                        <!-- <?php if(isset($quote)){echo $quote->total; }?> -->
                        <input type="number" class="form-control" id="contract_incurred" name="incurred" value="0" readonly>
                        <div class="input-group-addon">
                           <?php echo $base_currency->symbol; ?>
                        </div>
                     </div>
                  ...
                  <?php if(!$selected){$selected = (isset($quote) ? '2' : '');} ?>
                  ...
                  <?php echo render_textarea('description','contract_description',$value,array('rows'=>10),array(),''); ?>
                           ...
                           <div id="ex-gift" class="col-md-12" style="padding:0px;">
                              ...
                              <div class="col-md-12" style="    margin-bottom: 10px; padding: 0px;">
                                 ...
                                 <div class="col-xs-11 col-md-5">
                                    <label>Phí phát sinh </label>
                                    <input type="text" class="pay_incurred_class" onkeyup="formart_num('pay_incurred<?php echo $k ?>')" id="pay_incurred<?php echo $k ?>" value="<?php echo str_replace(',','.',number_format($value->tblincurred_price)) ?>" name="incurred[<?php echo $k ?>][pay_incurred]" style="width: 100%">
                                 </div>
...
<script>
   ...
   $(document).on('keyup','.pay_incurred_class',function(){
      var total_inclu = 0;
      $.each($('.pay_incurred_class'), function( key, value ) {
        total_inclu += ($(value).val().replace(/\./g, '')*1);
      });
      $('#contract_incurred').val(total_inclu);
   })
