        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="bold no-margin">Điều chỉnh số lượng kho nội địa</h4>
                    <hr class="no-mbot no-border">
                    <a href="<?=admin_url('imports/internal_detail')?>" class="btn btn-info pull-left display-block"><?php echo _l('Thêm phiếu điều chỉnh'); ?></a>
                    </div>
                </div>
