               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                        ...
                        <p><a href="#" class="font-medium" onclick="init_report(this,'quotes-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('Báo cáo báo giá'); ?></a></p>
                        <hr class="hr-10" />
                        <p><a href="#" class="font-medium" onclick="init_report(this,'contracts-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('Báo cáo hợp đồng'); ?></a></p>
                        <hr class="hr-10" />
                        <p><a href="#" class="font-medium" onclick="init_report(this,'tasks-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('Lịch sử giao dịch'); ?></a></p>
                        <hr class="hr-10" />
         ...
         <div class="col-md-12">
            <div class="panel_s hide" id="report">
               <div class="panel-body">
                  ...
                  <?php $this->load->view('admin/reports/includes/sales_quotes'); ?>
                  <?php $this->load->view('admin/reports/includes/sales_contracts'); ?>
                  <?php $this->load->view('admin/reports/includes/sales_tasks'); ?>
