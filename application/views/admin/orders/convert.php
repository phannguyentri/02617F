                ...
                <div class="row">
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">            
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_purchase_suggested" class="form-control" value="<?php echo $purchase_suggested->code ?>" readonly>
                    </div>
                    ...
                    <?php
                        ...
                        echo render_date_input( 'date', 'project_datecreated' , $default_date_create , 'date'); 
                    ?>
                    <?php
                            ...
                            <table class="table items item-purchase no-mtop">
                                ...
                                <tbody>
                                    ...
                                    <tr class="sortable item">
                                        ...
                                        <td><input readonly="readonly" class="mainQuantity" type="number" name="items[<?php echo $i; ?>][quantity]" value="<?php echo $value->product_quantity; ?>"></td>
